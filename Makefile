...
DEFINE_FLAGS = -D TIMESTEPS=1 -D TIMESTEP_DURATION=1e-15 -D CELL_CUTOFF_RADIUS_ANGST=10

SIMULATIONS = $(BUILD_DIR)/naive $(BUILD_DIR)/nsquared $(BUILD_DIR)/nsquared_shared $(BUILD_DIR)/nsquared_n3l $(BUILD_DIR)/cell_list
