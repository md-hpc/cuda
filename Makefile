...
DEFINE_FLAGS = -D TIMESTEPS=500 -D TIMESTEP_DURATION_FS=2.5e-13 -D CELL_CUTOFF_RADIUS_ANGST=100 -D UNIVERSE_LENGTH=300 -D CELL_LENGTH_X=10 -D CELL_LENGTH_Y=10 -D CELL_LENGTH_Z=10 -D SIMULATE
