...
nvcc -I./include -D TIMESTEPS=1 -D TIMESTEP_DURATION_FS=2.5e-13 -D UNIVERSE_LENGTH=1000 -D TIME_RUN -D src/pdb_importer.c src/nsquared_n3l.cu -o build/nsquared_n3l
