...
nvcc -I./include -D TIMESTEPS=1 -D TIMESTEP_DURATION_FS=2.5e-13 -D UNIVERSE_LENGTH=300 -D TIME_RUN src/pdb_importer.c src/nsquared_shared.cu -o build/nsquared_shared
